...
class ProjectPanel extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            linkDesc: props.project.linkDesc,
    ...
    render() {
        if (isMobile()) {
            return(
                <div className="panelParentMobile">
                    <div className="projectLogo">
                        <img className='logoImg' src={process.env.PUBLIC_URL + this.state.icon} />
                    </div>
                    <div className="panelTextMobile">
